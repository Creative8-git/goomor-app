...
const HotspotViewer = () => {
  ...
  const hotspots = [
...

    {
      x: 98.5,
      y: 27,
      label: '6. Steel External Apex 22.5Deg',
      ...
      image: 'https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Accessories/Steel+External+Apex+100x50x22.5Deg.png',
...

    {
      x: 98,
      y: 38,
      label: '8. Steel Gable End Bracket 22.5 degrees',
      description: 'Available in 6 standard colors, Powder coat option available',
      length: [''],
      dimensions: ['Standard by provider, compatible with our range of beams'],
      color: ['6 standard colors, Powder coat option available'],
    ...
    
    {
      x: 98.5,
      y: 72,
      label: '14. Steel Collar Tie for 22.5 degrees',
      description: 'Available in 6 standard colors, Powder coat option available',
      length: [''],
      dimensions: ['Standard by provider, compatible with our range of beams'],
      color: ['6 standard colors, Powder coat option available'],
      image: 'https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Accessories/Steel+Collar+Tie+100x50+22.5dg.png',
      link: '/goomor/Accessories/'
    },
      ...
      <div className="bg-gray-100 min-h-screen flex items-center justify-center">
        <div className="w-full px-4 sm:px-8 lg:px-16">
          <div className="text-center my-20">
            <h2 className="text-4xl sm:text-5xl font-bold mb-4" style={{ color: '#df5e17' }}>
              Free Standing Patio with Gable Roof 22.5 Degrees
            </h2>
          ...
          <div className="mt-16 w-full max-w-6xl mx-auto rounded-lg overflow-hidden text-center">
            ...
            <img
              src="https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Patios/Gable+22/Pic/gable+225.jpg" // Replace with actual hosted path if needed
        ...
        <h3 className="text-2xl font-semibold text-[#df5e17] mb-4">
          ...
          <div id="hotspot-section" className="relative w-full max-w-6xl mx-auto rounded-lg overflow-visible shadow-lg">
            ...
            <img
              src="https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Patios/Gable+22/Pic/Gable+22.5+Degree.png"
              alt="Room"
