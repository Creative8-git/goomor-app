  ...
  const items = [
    {
      ...
      src: 'https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Patios/FreeStanding/pic/FREE+STANDING.jpg',
      path: '/goomor/freestandingpatio'
    },
    {
      label: 'Attached Patios Type 1',
      src: 'https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Patios/Wall-Attached/Pic/PIC+ATTACK+WALL+1.jpg',
      path: '/goomor/attachedpatio'
    },
    {
      label: 'Attached Patios Type 2',
      src: 'https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Patios/Wall-Attached2/Pic/PIC+ATTACK+WALL+2.jpg',
      path: '/goomor/attachedpatio2'
    },
    {
      label: 'Flyover Patios',
      src: 'https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Patios/FlyOver/Pic/Flyover.jpg',
      path: '/goomor/flyoverpatios'
    },
    {
      label: 'Flyover Over Hang Patios',
      src: 'https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Patios/Flyover+Over+Hang+Type/Pic/Flyover+overhang.jpg',
      path: '/goomor/flyoveroverhangpatios'
    },
    {
      label: 'Free Standing patios with Gable roof 22.5 Degrees',
      src: 'https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Patios/Gable+22/Pic/gable+225.jpg',
      path: '/goomor/gable225'
    },
    {
      label: 'Free Standing patios with Gable roof 15 Degrees',
      src: 'https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Patios/Gable+15/Pic/Gable+15.jpg',
      path: '/goomor/gable15'
    },
  ];
