      ...
      <div className="bg-gray-100 min-h-screen flex items-center justify-center">
        <div className="w-full px-4 sm:px-8 lg:px-16">
          ...
          <div className="mt-16 w-full max-w-6xl mx-auto rounded-lg overflow-hidden text-center">
            ...
            <img
              src="https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Patios/Flyover+Over+Hang+Type/Pic/Flyover+overhang.jpg" // Replace with actual hosted path if needed
        ...
        <h3 className="text-2xl font-semibold text-[#df5e17] mb-4">
          ...
          <div id="hotspot-section" className="relative w-full max-w-6xl mx-auto rounded-lg overflow-visible shadow-lg">
            ...
            <img
              src="https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Patios/Flyover+Over+Hang+Type/Pic/FlyOver+Patio+Over+Hang+Type.png"
              alt="Room"
