...
const HotspotViewer = () => {
  ...
  const hotspots = [
...

    {
      x: 98,
      y: 8,
      label: '2. Valley Gutter',
      description: 'Available in standard colorbond colors',
      length: ['Varied sizes, can be delivered up to 9m'],
      dimensions: ['Varied sizes, can be delivered up to 9m'],
      color: ['Can be powder coated'],
      image: 'https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Flashing/Lysaght/StandardFlashing/ValleyGutter.png',
...

    {
      x: 5.5,
      y: 15.5,
      label: '3. Metal Flashing',
      description: 'Available in standard colorbond colors',
      length: ['Varied sizes, can be delivered up to 9m'],
      dimensions: ['Varied sizes, can be delivered up to 9m'],
      color: ['Can be powder coated'],
      image: 'https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Flashing/Lysaght/CustomFlashing/CustomFlashing13.png',
      link: '/Product/flashing'
    },
...

    {
      x: 9,
      y: 26.5,
      label: '5. Metal Edge Gutter stop-end',
      description: 'Available in standard colorbond colors',
      length: ['N/a'],
      dimensions: [''],
...

    {
      x: 98.5,
      y: 27,
      label: '6. Steel External Apex 15Deg',
      description: 'Available in 6 standard colors, Powder coat option available',
      length: [''],
      dimensions: ['Standard by provider, compatible with our range of beams'],
      color: ['6 standard colors, Powder coat option available'],
      image: 'https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Accessories/Steel+External+Apex+100x50x15Deg.png',
...

    {
      x: 98,
      y: 40,
      label: '8. Steel Gable End Bracket 15 degrees',
      description: 'Available in 6 standard colors, Powder coat option available',
      length: [''],
      dimensions: ['Standard by provider, compatible with our range of beams'],
      color: ['6 standard colors, Powder coat option available'],
      image: 'https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Accessories/Steel+Gable+End+Bracket+100x50x15Deg.png',
      link: '/goomor/Accessories/'
    },
...

    {
      x: 103,
      y: 46.5,
      label: '10. Polycarbonate/Fiberglass wall Panel',
      description: 'Wide range of options available',
      length: ['N/a'],
      dimensions: ['Standard by provider'],
      color: ['6 standard colors'],
      image: 'https://www.stratco.com.au/globalassets/catalog/product-images/mwal101050cl20_01.jpg?w=660&h=660',
      link: '/fibreproducts'
    },
    ...
    
    {
      x: 98.5,
      y: 62,
      label: '12. Steel Beam End Rafter Bracket',
      description: 'Available in 6 standard colors, Powder coat option available',
      length: [''],
      dimensions: ['Standard by provider, compatible with our range of beams'],
      color: ['6 standard colors, Powder coat option available'],
      image: 'https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Accessories/Steel+Beam+End+Rafter+Bracket+100x50-25+dg.png',
      link: '/goomor/Accessories/'
    },

    {
      ...
      length: ['N/a'],
      dimensions: ['Varied sizes, Designed to fit most post'],
    ...
    
    {
      x: 99,
      y: 72,
      label: '14. Steel Collar Tie for 15 degrees',
      description: 'Available in 6 standard colors, Powder coat option available',
      length: [''],
      dimensions: ['Standard by provider, compatible with our range of beams'],
      color: ['6 standard colors, Powder coat option available'],
      image: 'https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Accessories/Steel+Collar+Tie+100x50x15Deg.png',
      link: '/goomor/Accessories/'
    },

    {
      x: 8,
      y: 81,
      label: '15. Free Standing Post Holder',
      ...
      
    {
      x: 10,
      y: 90,
      label: '17. Nozzle for PVC Downpipes 80mm',
      description: 'Available in 6 standard colors, Powder coat option available',
      length: [''],
      dimensions: ['Standard by provider'],
...

    {
      x: 8,
      y: 99,
      label: '19. Pvc Downpipe Clip 80mm',
      description: 'Available in 6 standard colors ',
      length: ['N/a'],
      dimensions: ['Standard by provider'],
      color: ['6 standard colors'],
      ...
      <div className="bg-gray-100 min-h-screen flex items-center justify-center">
        <div className="w-full px-4 sm:px-8 lg:px-16">
          <div className="text-center my-20">
            <h2 className="text-4xl sm:text-5xl font-bold mb-4" style={{ color: '#df5e17' }}>
              Free Standing Patio with Gable Roof 15 Degrees
            </h2>
            <p className="text-gray-600 text-base sm:text-lg max-w-2xl mx-auto mb-6">
              Transform Your Outdoor Space with our Patios.
          ...
          <div className="mt-16 w-full max-w-6xl mx-auto rounded-lg overflow-hidden text-center">
            ...
            <img
              src="https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Patios/Gable+15/Pic/Gable+15.jpg" // Replace with actual hosted path if needed
        ...
        <h3 className="text-2xl font-semibold text-[#df5e17] mb-4">
          ...
          <div id="hotspot-section" className="relative w-full max-w-6xl mx-auto rounded-lg overflow-visible shadow-lg">
            ...
            <img
              src="https://goomorproductimage.s3.ap-southeast-2.amazonaws.com/Goomor/Patios/Gable+15/Pic/Gable+15+Degree.png"
              alt="Room"
