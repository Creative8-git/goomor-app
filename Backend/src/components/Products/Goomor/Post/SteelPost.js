...
const SteelPost = () => {
    ...
    // Filter products with type "steel post" and search query
    const items = products
        .filter(product => product.type === 'steel post') // Filter by product type
        ...
        <div className="container-fluid service bg-light pb-5 Post">
            <div className="container pb-5">
                ...
                <div className="d-flex align-items-center mb-2">
                    ...
                    />
                    <h1 className="m-0" style={{ fontSize: "50px", lineHeight: "50px" }}>Steel Post</h1>
                </div>
