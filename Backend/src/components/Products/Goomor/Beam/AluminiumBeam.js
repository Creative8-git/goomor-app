...
const AluminiumBeam = () => {
    ...
    // Filter products with type "aluminium beam" and search query
    const items = products
        .filter(product => product.type === 'aluminium beam') // Filter by type
        ...
        <div className="container-fluid service bg-light pb-5 Post">
            <div className="container pb-5">
                ...
                <div className="d-flex align-items-center mb-2">
                    ...
                    />
                    <h1 className="m-0" style={{ fontSize: "50px", lineHeight: "50px" }}>Aluminum Beam</h1>
                </div>
