...
const SteelBeam = () => {
    ...
    // Filter products with type "steel beam" and search query
    const items = products
        .filter(product => product.type === 'steel beam') // Filter by type
    ...
    return (
        <div className="container-fluid service bg-light pb-5 Beam">
            <div className="container pb-5">
                {/* Search Bar */}
                <div className="mb-4">
                    <input
                        type="text"
                        placeholder="Search for a beam..."
                        value={searchQuery}
                ...
                <div className="d-flex align-items-center mb-2">
                    ...
                    />
                    <h1 className="m-0" style={{ fontSize: "50px", lineHeight: "50px" }}>Steel Beam</h1>
                </div>
