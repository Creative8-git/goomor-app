...
const Versiclad = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch(`${process.env.REACT_APP_API_URL}/api/versicladproducts`); // Replace with your actual API endpoint
              ...
              <div className="wow fadeInUp" data-wow-delay={`${index * 0.2}s`}>
                ...
                >
                  <div className="service-img">
                    <img
                      src={product.carouselImages?.[0] || "/images/placeholder.png"} // Placeholder for missing images
