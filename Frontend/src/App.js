...
import StandardFlashingCatalogue from './components/Products/Flashing/StandardFlashingCatalogue';
import CustomFlashingCatalogue from './components/Products/Flashing/CustomFlashingCatalogue';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/standardflashing" element={<StandardFlashingCatalogue />} />
      <Route path="/standardflashing/:productId" element={<StandardFlashingCatalogue />} />

      <Route path="/customflashing" element={<CustomFlashingCatalogue />} />
      <Route path="/customflashing/:productId" element={<CustomFlashingCatalogue />} />
