...
const HotspotViewer = () => {
  ...
  const hotspots = [
...

    {
      ...
      image: '/goomorproductimage/Flashing/Lysaght/StandardFlashing/BargeGutter.png',
...

    {
      x: 98.5,
      y: 31,
      label: '6. Colorbond Edge Gutter stop-end',
      description: 'Available in standard colorbond colors',
      length: ['N/a'],
      dimensions: [''],
...

    {
      x: 98.5,
      y: 41.5,
      label: '8. Insulation Downlight Kit',
...

    {
      ...
      dimensions: [''],
      color: ['Can be Powder coated'],
      image: '/goomorproductimage/Goomor/Accessories/Fasica+Riser+Bracket+600.png',
      link: '/goomor/beam'
    },
...

    {
      x: 4.5,
      y: 89,
      label: '15. Post Holder',
      description: 'Available in base metal finish',
      length: ['N/a'],
      dimensions: ['Suitable for most post'],
      color: ['Base metal finish, can be powder coated'],
      image: '/goomorproductimage/Goomor/Accessories/Steel+Post+Holder+90+mm.png',
      link: '/goomor/post'
    },

    {
      x: 99.5,
      y: 89.5,
      label: '16. Pvc Downpipe Clip 80mm',
      description: 'Available in 6 standard colors ',
      length: ['N/a'],
      dimensions: ['Standard by provider'],
      color: ['6 standard colors'],
      ...
      <div className="bg-gray-100 min-h-screen flex items-center justify-center">
        <div className="w-full px-4 sm:px-8 lg:px-16">
          ...
          <div className="mt-16 w-full max-w-6xl mx-auto rounded-lg overflow-hidden text-center">
            ...
            <img
              src={getAssetUrl("/goomorproductimage/Goomor/Patios/Flyover+Over+Hang+Type/Pic/Flyover+overhang.jpg")}
        ...
        <h3 className="text-2xl font-semibold text-[#df5e17] mb-4">
          ...
          <div id="hotspot-section" className="relative w-full max-w-6xl mx-auto rounded-lg overflow-visible shadow-lg">
            ...
            <img
              src={getAssetUrl("/goomorproductimage/Goomor/Patios/Flyover+Over+Hang+Type/Pic/FlyOver+Patio+Over+Hang+Type.png")}
              alt="Room"
