...
const HotspotViewer = () => {
  ...
  const hotspots = [
...

    {
      ...
      image: '/goomorproductimage/Flashing/Lysaght/StandardFlashing/ValleyGutter.png',
...

    {
      x: 5.5,
      y: 15.5,
      label: '3. Colorbond Flashing',
      description: 'Available in standard colorbond colors',
      length: ['Varied sizes, can be delivered up to 9m'],
      dimensions: ['Varied sizes, can be delivered up to 9m'],
      color: ['Can be powder coated'],
      image: '/goomorproductimage/Flashing/Lysaght/CustomFlashing/CustomFlashing13.png',
      link: '/Product/flashing'
    },
...

    {
      ...
      image: '/goomorproductimage/Goomor/Accessories/Steel+External+Apex+100x50x22.5Deg.png',
      link: '/goomor/beam'
    },

    {
      ...
      dimensions: ['Standard by provider'],
      color: ['6 standard colors, Powder coat option available'],
      image: '/goomorproductimage/Goomor/Accessories/Beam+165.png',
      link: '/goomor/beam'
    },

    {
      x: 98.5,
      y: 40,
      label: '8. Steel Gable End Bracket',
      description: 'Available in 6 standard colors, Powder coat option available',
      length: [''],
      dimensions: ['Standard by provider, compatible with our range of beams'],
      color: ['6 standard colors, Powder coat option available'],
      image: '/goomorproductimage/Goomor/Accessories/Steel+Gable+End+Bracket+100x50x15Deg.png',
      link: '/goomor/beam'
    },
...

    {
      ...
      description: 'Stainless steel/Aluminium, available in variety of colors',
...

    {
      ...
      dimensions: ['Standard by provider, compatible with our range of beams'],
      color: ['6 standard colors, Powder coat option available'],
      image: '/goomorproductimage/Goomor/Accessories/Steel+Beam+End+Rafter+Bracket+100x50-25+dg.png',
      link: '/goomor/beam'
    },
...

    {
      ...
      dimensions: ['Standard by provider, compatible with our range of beams'],
      color: ['6 standard colors, Powder coat option available'],
      image: '/goomorproductimage/Goomor/Accessories/Steel+Collar+Tie+100x50+22.5dg.png',
      link: '/goomor/beam'
    },

    {
      ...
      color: ['Can be Powder coated'],
      image: '/goomorproductimage/Goomor/Accessories/Steel+Bottom+Post+Freestanding+110.png',
      link: '/goomor/post'
    },
      ...
      <div className="bg-gray-100 min-h-screen flex items-center justify-center">
        <div className="w-full px-4 sm:px-8 lg:px-16">
          ...
          <div className="mt-16 w-full max-w-6xl mx-auto rounded-lg overflow-hidden text-center">
            ...
            <img
              src={getAssetUrl("/goomorproductimage/Goomor/Patios/Gable+22/Pic/gable+225.jpg")}
          ...
          <div id="hotspot-section" className="relative w-full max-w-6xl mx-auto rounded-lg overflow-visible shadow-lg">
            ...
            <img
              src={getAssetUrl("/goomorproductimage/Goomor/Patios/Gable+22/Pic/Gable+22.5+Degree.png")}
              alt="Room"
