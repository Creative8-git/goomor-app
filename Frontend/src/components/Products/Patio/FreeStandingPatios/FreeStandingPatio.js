...
const HotspotViewer = () => {
  ...
  const hotspots = [
...

    {
      x: 94,
      y: 23,
      label: '2. Insulation Downlight Kit',
...

    {
      ...
      color: ['Standard Metal Colors'],
      image: '/goomorproductimage/Flashing/Lysaght/StandardFlashing/EdgeGutter.png',
    ...
    
    {
      x: 16,
      y: 44,
      label: '7. Nozzle for PVC Downpipes 80mm',
      description: 'Available in 6 standard colors, Powder coat option available',
      length: [''],
      dimensions: ['Standard by provider'],
    ...
    },
    {
      x: 94.4,
      y: 80.5,
      label: '10. Free standing post holder',
    ...
    
    {
      x: 94.5,
      y: 92,
      label: '12. PVC Downpipe Clip',
      description: 'Available in 4 standard colors',
      length: ['N/a'],
      dimensions: [''],
      color: ['Available in 4 standard colors'],
      ...
      <div className="bg-gray-100 min-h-screen flex items-center justify-center">
        <div className="w-full px-4 sm:px-8 lg:px-16">
          ...
          <div className="mt-16 w-full max-w-6xl mx-auto rounded-lg overflow-hidden text-center">
            ...
            <img
              src={getAssetUrl("/goomorproductimage/Goomor/Patios/FreeStanding/pic/FREE+STANDING.jpg")}
          ...
          <div id="hotspot-section" className="relative w-full max-w-6xl mx-auto rounded-lg overflow-visible shadow-lg">
            ...
            <img
              src={getAssetUrl("/goomorproductimage/Goomor/Patios/FreeStanding/pic/FreeStanding+Patio.png")}
              alt="Room"
