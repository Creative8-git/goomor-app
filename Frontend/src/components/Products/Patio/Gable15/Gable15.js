...
const HotspotViewer = () => {
  ...
  const hotspots = [
...

    {
      x: 10,
      y: 26.5,
      label: '5. Colorbond Edge Gutter stop-end',
      description: 'Available in standard colorbond colors',
      length: ['N/a'],
      dimensions: [''],
...

    {
      ...
      image: '/goomorproductimage/Goomor/Accessories/Steel+External+Apex+100x50x15Deg.png',
      link: '/goomor/beam'
    },
...

    {
      ...
      dimensions: ['Standard by provider, compatible with our range of beams'],
      color: ['6 standard colors, Powder coat option available'],
      image: '/goomorproductimage/Goomor/Accessories/Steel+Collar+Tie+100x50x15Deg.png',
      link: '/goomor/beam'
    },
      ...
      <div className="bg-gray-100 min-h-screen flex items-center justify-center">
        <div className="w-full px-4 sm:px-8 lg:px-16">
          ...
          <div className="mt-16 w-full max-w-6xl mx-auto rounded-lg overflow-hidden text-center">
            ...
            <img
              src={getAssetUrl("/goomorproductimage/Goomor/Patios/Gable+15/Pic/Gable+15.jpg")}
          ...
          <div id="hotspot-section" className="relative w-full max-w-6xl mx-auto rounded-lg overflow-visible shadow-lg">
            ...
            <img
              src={getAssetUrl("/goomorproductimage/Goomor/Patios/Gable+15/Pic/Gable+15+Degree.png")}
              alt="Room"
