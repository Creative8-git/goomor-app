...
const suppliers = [
  {
    name: 'Post',
    path: '/goomor/post',
    logo: '/goomorproductimage/Goomor/Accessories/post+50.png',
  },
  {
    name: 'Beam',
    path: '/goomor/beam',
    logo: '/goomorproductimage/Goomor/Accessories/Beam+100.png',
  },
  {
    name: 'Accessories',
    path: '/goomor/accessories',
    logo: '/goomorproductimage/Goomor/Accessories/Steel+Gable+End+Bracket+225x50x225deg.png',
  },
];
