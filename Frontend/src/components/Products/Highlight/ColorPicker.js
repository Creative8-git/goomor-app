    ...
    <div className="row mt-5">
      ...
      <div className="col-md-12 mt-3">
        <div className="custom-toggle">
          <span className={!viewDoubleSide ? 'active' : ''}>Single colors</span>
          <div
          ...
          <span className={viewDoubleSide ? 'active' : ''}>Double-Sided options</span>
        </div>
      </div>
          ...
          <div className="col-sm-4 text-center">
            <div
              ...
              style={{
                ...
                alignItems: 'center',
                justifyContent: 'center',
                margin: '40px auto 0', // vertically offset + centered
              }}
            ></div>
            <p
