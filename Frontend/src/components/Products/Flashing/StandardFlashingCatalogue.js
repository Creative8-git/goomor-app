...
const StandardFlashingCatalogue = () => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                const response = await fetch(`${process.env.REACT_APP_API_URL}/api/standardflashing/${productId}`);
                if (!response.ok) {
...
export default StandardFlashingCatalogue;
