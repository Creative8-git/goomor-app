...
const FasciaGutter = () => {
    ...
    const items = filteredProducts.map(product => ({
        ...
        image: getAssetUrl(product.carouselImages?.[0]) || "path/to/default/image.jpg", // Fallback for missing or undefined image
    }));
        ...
        <div className="container-fluid service bg-light pb-5 AmpeLite">
            <div className="container pb-5">
                <div className="text-center mx-auto pb-5 wow fadeInDown" data-wow-delay="0.1s" style={{ maxWidth: "800px" }}>
                    {/* Company Logo */}
                    <img
                        src={getAssetUrl("/goomorproductimage/Util/Images/Gutter.png")}
                        alt=""
                            ...
                            <div className="wow fadeInUp" data-wow-delay={`${0 + index * 0}s`}>
                                ...
                                >
                                    <div className="service-img">
                                        <img src={getAssetUrl(item.image)} className="img-fluid w-100" alt={item.name} />
                                    </div>
